...
const templatingWithMustache = () => {
  // Solution code here...
  let templateStringsArr = [];
  let mustachTemplate = $('#template').html();
  characters.forEach(e => {
    templateStringsArr.push(Mustache.render(mustachTemplate,e))
  })
  return templateStringsArr;
};
...
const hasChildrenValues = (arr, character) => {
  // Solution code here...
   let x = false;
   arr.forEach(e => {
     let arrOfValues = Object.values(e);
     if (arrOfValues[0] === character && arrOfValues[2].length !==0){
       x = true;
     }
   });
   return x;
